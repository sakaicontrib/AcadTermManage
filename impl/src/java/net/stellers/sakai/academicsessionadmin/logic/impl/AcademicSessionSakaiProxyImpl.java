...
public class AcademicSessionSakaiProxyImpl implements AcademicSessionSakaiProxy {
	...
	public List<Site> getSitesForTerm (String termEID) {
		...
		propCriteria.put(SakaiConstants.PROP_NAME_TERM_EID, termEID);
	...
	public void notifyEventServiceOfUpdate (String termEid) {	
		Event update = eventService.newEvent(SakaiConstants.EVENTSERVICE_EVENT_ACADEMICSESSION_UPDATE, 
				SakaiConstants.EVENTSERVICE_EVENT_RESOURCE_PREFIX+termEid, true);
		eventService.post(update);		
	}
	
	@Override
	public void notifyEventServiceOfInsert (String termEid) {	
		Event update = eventService.newEvent(SakaiConstants.EVENTSERVICE_EVENT_ACADEMICSESSION_ADD, 
				SakaiConstants.EVENTSERVICE_EVENT_RESOURCE_PREFIX+termEid, true);
		eventService.post(update);		
	}
